...
#define LCD_Height 640				  //	LCD的像素宽度
...
#define LED1_ON HAL_GPIO_WritePin(LED_GPIO_Port, LED_Pin, GPIO_PIN_RESET)							// 输出低电平，点亮LED1
#define LED1_OFF HAL_GPIO_WritePin(LED_GPIO_Port, LED_Pin, GPIO_PIN_SET)							// 输出高电平，关闭LED1
#define LED1_Toggle HAL_GPIO_TogglePin(LED_GPIO_Port, LED_Pin);										// 翻转IO口状态
