...
-Ilvgl/examples \
-Ilvgl/examples/anim \
-Ilvgl/examples/event \
-Ilvgl/examples/get_started \
-Ilvgl/examples/layouts \
-Ilvgl/examples/layouts/flex \
-Ilvgl/examples/layouts/grid \
-Ilvgl/examples/libs \
-Ilvgl/examples/libs/bmp \
-Ilvgl/examples/libs/ffmpeg \
-Ilvgl/examples/libs/freetype \
-Ilvgl/examples/libs/gif \
-Ilvgl/examples/libs/png \
-Ilvgl/examples/libs/qrcode \
-Ilvgl/examples/libs/rlottie \
-Ilvgl/examples/libs/sjpg \
-Ilvgl/examples/others \
-Ilvgl/examples/others/fragment \
-Ilvgl/examples/others/gridnav \
-Ilvgl/examples/others/ime \
-Ilvgl/examples/others/imgfont \
-Ilvgl/examples/others/monkey \
-Ilvgl/examples/others/msg \
-Ilvgl/examples/others/snapshot \
-Ilvgl/examples/porting \
-Ilvgl/examples/scroll \
-Ilvgl/examples/styles \
-Ilvgl/examples/widgets \
-Ilvgl/src \
-Ilvgl/src/core \
-Ilvgl/src/draw \
