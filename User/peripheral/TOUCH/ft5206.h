...
// IO操作函数
#define FT_RST(n) (n ? HAL_GPIO_WritePin(GPIOE, GPIO_PIN_2, GPIO_PIN_SET) : HAL_GPIO_WritePin(GPIOE, GPIO_PIN_2, GPIO_PIN_RESET)) // FT5206复位引脚
#define FT_INT HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_3)                                                                                // FT5206断引脚
